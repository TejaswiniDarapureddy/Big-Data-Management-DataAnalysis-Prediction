...
spark = SparkSession.builder.appName("Assignment3_Group4_Task3_PartB").getOrCreate()
...
rf.show(20)
#RegressionEvaluator function is used on prediction col and label col for caluculating rmse value
evaluator = RegressionEvaluator(labelCol="Year", predictionCol="prediction", metricName="rmse")
print("RMSE Value:",evaluator.evaluate(rf_predictions))
#RegressionEvaluator function is used on prediction col and label col for caluculating r2 value
evaluator = RegressionEvaluator(labelCol="Year", predictionCol="prediction", metricName="r2")
print("R2 Value:",evaluator.evaluate(rf_predictions))
